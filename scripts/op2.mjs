...
import { stepDie, dieLabel, dieIndex } from "./dice/die-step.mjs";
...
Hooks.once("init", () => {
	...
	if (module) {
		module.api = { OP2, OP2Roll, OP2AgentData, OP2AgentSheet, rollTest, buildFlavor, evaluateTest, stepDie, dieLabel, dieIndex };
	}
